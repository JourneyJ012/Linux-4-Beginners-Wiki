---
Distros: Linux Mint
Parts that may require Updates: rufus-4.xx version
---
...
### 1.1.1b For Fedora
Visit the [download](https://fedoraproject.org/kde/download/) page on the official Fedora site. There are multiple versions available, but "Fedora KDE Plasma Desktop" and "Fedora Workstation" are the relevant ones. You want the "For Intem and AMD x86_64 systems".
...
To use Rufus:
- Visit their website
- Scroll to Download, and choose "rufus-4.14p.exe"
- Open Rufus
...
- Skip the rest of the options, press start and accept any popups (**This WILL erase ALL data on the Flash Drive. Just like your key documents, back up anything you have that's important to either another flash drive or to the cloud.**)
...
**THIS IS THE POINT OF NO RETURN FROM WINDOWS. If you carry on, you will lose everything on Windows and will need to re-install it, losing all your documents.**
